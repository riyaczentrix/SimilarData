...
try:
    ...
    nltk.download('punkt', quiet=True) # Ensure 'punkt' is downloaded for tokenization
try:
    nltk.data.find('tokenizers/punkt_tab')
except LookupError: # Changed from nltk.downloader.DownloadError to LookupError
    nltk.download('punkt_tab', quiet=True) # Download 'punkt_tab' as requested
...
try:
    ...
    sys.exit(1) # Exit if the core library cannot be imported
